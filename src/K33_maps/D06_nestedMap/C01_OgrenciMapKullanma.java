...
public class C01_OgrenciMapKullanma {
    public static void main(String[] args) {
        ...
        System.out.println((ogrenciNestedMap.get(103).get("soyisim")));


        // 101 numarali ogrencinin bolumunu yazdirin

        System.out.println(ogrenciNestedMap.get(101).get("bolum"));


        // 102 numarali ogrencinin subesini K yapin

        ogrenciNestedMap.get(102).replace("sube","K");


        // 101 numarali ogrencinin bolumunu TM yapin


        ogrenciNestedMap.get(101).replace("bolum","TM");
